'''
module to perform BED operations in python, not using bedtools
John Dicarlo, Qiagen, June 2015
'''

__version__ = 1.0
__author__  = 'john.dicarlo@qiagen.com'
...
def write(regions, fileName):
   ...
   (fileNameBase, fileExt) = os.path.splitext(fileNameBase)
   fileout = open(fileName, "w")
   fileout.write("track name='{0}' description='{0}'".format(fileNameBase))
   if fileExt == ".bedgraph":
      fileout.write(" type=bedGraph")
   fileout.write("\n")
   for row in regions:
